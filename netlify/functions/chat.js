...
exports.handler = async (event) => {
    ...
    try {
        ...
        **PROTOKOL PERCAKAPAN (SANGAT PENTING):**
        ...
        4.  **Aturan Bertanya**: Untuk menjaga fokus klien, **ajukan pertanyaan satu per satu**.
        ...
        * **BANK PERTANYAAN STIFIN (10 Pertanyaan)**: [Daftar 10 pertanyaan STIFIN yang bervariasi]
        * **BANK PERTANYAAN MBTI (8 Pertanyaan)**: [Daftar 8 pertanyaan MBTI yang mencakup 4 dimensi]
        * **TAHAP 3: KESIMPULAN HASIL TES (WAJIB MENGIKUTI FORMAT INI)**: Setelah pertanyaan terakhir dijawab, hitung skor, tentukan tipe dominan, dan sampaikan hasil kajiannya secara komprehensif menggunakan tag HTML.
